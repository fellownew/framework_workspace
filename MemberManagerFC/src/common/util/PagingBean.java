...
public class PagingBean {
	 ...
	 */
	public static int CONTENTS_PER_PAGE = 10;//한페이지에 10개의 내용(Row)를 보여준다.
	/**
	 * Page Group 내 Page 수.  페이지 그룹에 들어갈 페이지 개수
	 */
	public static int PAGE_PER_PAGEGROUP = 5;//5개의 page를 하나의 그룹으로 묶는다.
	
	/**
	 * 총 데이터(내용) 개수, 현재 페이지를 받아 member variable에 할당
	 * @param totalContent - 총 컨텐츠의 개수
	 * @param currentPage - 현재 보려고 하는 페이지
	 */
